...
* Pause (spacebar) - The Pause button will pause the tutorial to be resumed later.
...
### Music Creator
The Music Creator screen will scroll up to 16 bars allowing the user to place notes to create music. The music created will be able to be saved and played back later.
* Pause (spacebar) - The Pause function will pause the Music Creator to be resumed later.
* Home button - The Home button will return you to the Main Menu.
